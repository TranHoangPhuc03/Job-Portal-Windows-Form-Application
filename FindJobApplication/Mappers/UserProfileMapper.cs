    ...
    public class UserProfileMapper
    {
        public static UserProfile MapToModel(DataRow dr)
        {
            ...
            try
            {
                ...
                DateTime dateOfBirth = dr.Field<DateTime>("date_of_birth");
                string gender = dr.Field<string>("gender");
                string address = dr.Field<string>("address");
                string personalLink = dr.Field<string>("personal_link");
                string userImage = dr.Field<string>("user_image");
                string aboutMe = dr.Field<string>("about_me");
